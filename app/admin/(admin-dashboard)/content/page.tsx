...
import AdminAboutPage from "../about/page";
import AdminTeamPage from "../team/page";
import AdminFaqsPage from "../faqs/page";
import AdminSlidersPage from "../sliders/page";
...
function ContentTabs() {
  ...
  return (
    <div className="admin-editor mx-auto max-w-7xl">
      ...
      <div className="mt-6">
        {activeTab === "slider" && <AdminSlidersPage />}
        ...
        {activeTab === "about" && (
          <div>
            ...
            {aboutSub === "story" ? <AdminAboutPage /> : <AdminTeamPage />}
          </div>
        )}

        {activeTab === "stats" && <AdminStatsPage />}
        {activeTab === "faq" && <AdminFaqsPage />}
      </div>
    </div>
  );
}
