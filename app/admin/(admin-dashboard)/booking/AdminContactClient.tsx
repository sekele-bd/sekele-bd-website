...
type ContactData = { title: string | null; content: string } | null;

function parseContact(data: ContactData) {
  const result = {
    title: data?.title || "",
    address: "",
    phone: "",
  ...
  try {
    ...
    result.phone = content.phone || "";
    result.email = content.email || "";
    result.note = content.note || "";
    result.heroImage = content.heroImage || "";
  } catch {
    /* ignore */
  }
  return result;
