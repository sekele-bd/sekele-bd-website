...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    ...
    fetch("/api/admin/dashboard")
      ...
      .then((json) => {
        if (!cancelled && json && !json.error) setData(json);
      })
      .finally(() => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center p-8 h-[60vh]">
        <Loading variant="section" label="Loading dashboard…" />
      </div>
    );
  }
  ...
  if (!data) {
    return (
      <p className="rounded-lg border border-dashed border-neutral-200 bg-white py-16 text-center text-sm text-neutral-500">
        Could not load dashboard.
      </p>
    );
  }

  const { adminName, counts, recentItems } = data;
    ...
    <div className="mx-auto max-w-7xl space-y-8">
      <div className="flex flex-col gap-5 border-b border-neutral-200 pb-6 lg:flex-row lg:items-end lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-neutral-500">
            Manage your website content, albums and service offerings from one
            place.
          </p>
        </div>
        <div className="flex flex-wrap gap-3">
      ...
      <div className="grid gap-6 lg:grid-cols-5">
        <section className="rounded-lg border border-neutral-200 bg-white lg:col-span-3">
          <div className="border-b border-neutral-100 px-5 py-4">
            ...
            <p className="mt-0.5 text-sm text-neutral-500">
              Latest albums and packages you changed.
            </p>
          </div>
          <div className="divide-y divide-neutral-100">
            {recentItems.map((item) => (
        ...
        <section className="rounded-lg border border-neutral-200 bg-white lg:col-span-2">
          <div className="border-b border-neutral-100 px-5 py-4">
            ...
            <p className="mt-0.5 text-sm text-neutral-500">Jump to common tasks.</p>
          </div>
          <div className="space-y-1 p-3">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-neutral-500">
                  {counts.faqs} questions published
                </p>
              </div>
              <ArrowRight size={16} className="text-neutral-400" />
            </Link>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-neutral-500">
                  {counts.socials} links connected
                </p>
              </div>
              <ArrowRight size={16} className="text-neutral-400" />
            </Link>
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-xs text-neutral-500">
                  Review your phone, email and address
                </p>
              </div>
              <ArrowRight size={16} className="text-neutral-400" />
            </Link>
